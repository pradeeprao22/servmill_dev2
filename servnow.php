...
<body>
			...
			echo"<div class='center_content'>
			    <div class='prod_box_big'>
				  ...
				  <div class='details_big_boxa'>
					<div class='product_title_biga'>";?><?php echo '<p align="justify" style ="font-size:20px;" >Sorry, but the system believe that you are registered as a guest, please <a href="register.php">create an acount</a> or <a href = "login.php">log-in</a> in order to perform that action</p>';?>
					<?php echo"</div>";?>
					<?php echo'</div></div>';
		}else{
		$id = $_GET['id'];
    ...
    <?php echo "<div class='center_content'>
      ...
      <div class='prod_box_big'>
        <div class='center_prod_box_big'>
           <div class='product_img_big'>"; ?><?php echo "<a><img src='administrator/images/products/".$row['serviceimage']."' width='269' height='255' alt='' border='0' /></a>"; ?>
          <?php echo"</div>
          <div class='details_big_boxa'>
            <div class='product_title_biga'>";?><?php echo $row['servicename'];?><?php echo"</div>";?>
            ...
            <form method = "post" action="bidconfirm.php" id="logins-form" class="logins-form">
                <strong></strong><br /><input type="text" name="bidamount">
                <input type="submit" value="Place Bid" name="submit">
            </form>
				<span class="blue"><strong>';?><?php echo "(Enter Php".$row['startingbid']." or more)";?><?php echo'</strong></span><br />
