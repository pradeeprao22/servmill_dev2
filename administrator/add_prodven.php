...
if (isset($_POST['prodsave'])){
	...
	mysql_query("INSERT INTO services(servicname,categoryid,servicedescription,startingbid,serviceimage,regularprice,dateposted,duedate,status)
						VALUES ('$proname','$category','$descrpt','$startingbid','$name','$regularprice',NOW(),'$duedate',0)") or die(mysql_error());
	...
	else
	{
		...
		{
		move_uploaded_file($temp,"images/servmill/".$name);
		}
	}
...
<body>
	<div id="container">
		<div id="bgwrap">
            ...
            <li><a href="servs.php" class="dashboard"><img src="icons/2.png" alt /><span class="current">Servmill</span></a></li>
					...
					<h1>Welcome Administrator</h1>
						...
						<div class="two_third column">
                          ...
                          <form method="post" name="prodform" id="prodform" action="" enctype='multipart/form-data'>
                          		<div id="textcon">
                                	<p>Title of service:</p><br/>
                                 	<p>Starting Bid:</p><br/>
                                    <p>Regular Price:</p><br/>
                                    <p>Service Category:</p><br/>
                                 	<p>About your service:</p><br/><br/><br/>
                                    <p>Service Images:</p><br/>
                                </div>&nbsp;
                                <div id="inputcon">
