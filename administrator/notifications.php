...
<body>
	<div id="container">
		<div id="bgwrap">
			<div id="primary_left">
				<!-- <div id="logo">
				 	<a href="http://servmill.com/servadmin" title="Dashboard"><img src="./assets/logo.png" alt="" /></a>
					</div> 	 -->
				<!-- logo end -->
				<div id="menu"> <!-- navigation menu -->
					<ul>
						<li class="current"><a href="notifications.php"><img src="icons/73.png" alt /><span>Notifications</span></a></li>
            <li><a href="servs.php" class="dashboard"><img src="icons/2.png" alt /><span class="current">Services</span></a></li>
						<li class='showme'><a href="#"><img src="icons/36.png" alt /><span>All Services</span></a>
							<ul class='showoff'>
								<li><a href="add_prodven.php">Post Service</a></li>
								<li><a href="addcategory.php">Add Service Category</a></li>
							</ul>
						</li>
                        <li class='showme'><a href="#"><img src="./assets/icons/small_icons_3/settings.png" alt /><span>Admin Account</span></a>
							<ul class='showoff'>
			...
			<center><h1><br />Servmill Administrator</h1></center>
				<div class="inner">
				<!--join member and products-->
				<?php
				$bidnum = mysql_query("SELECT * FROM servicereport LEFT JOIN member ON member.memberid = servicereport.bidder LEFT JOIN services ON services.serviceid = servicereport.serviceid WHERE servicereport.status = 0") or die(mysql_error());
						$count = 0;
