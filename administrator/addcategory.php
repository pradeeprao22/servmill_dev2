...
<body>
	<div id="container">
		<div id="bgwrap">
            ...
            <li><a href="servs.php" class="dashboard"><img src="icons/2.png" alt /><span class="current">Bids</span></a></li>
						<li class='showme current'><a href="#"><img src="icons/36.png" alt /><span>Products</span></a>
						<ul class='showoff'>
						<li><a href="add_prodven.php">New service</a></li>
						<li><a href="addcategory.php">New service category</a></li>
						</ul>
						</li>
				...
				<div class="inner">
					...
					<h1>Welcome Administrator</h1>
						<div class="two_third column">
						  <h5>Add New Service Category</h5>
                           <div id="bodycon">
                          <form method="post" name="prodform" id="prodform" action="" enctype='multipart/form-data'>
							...
							<div id="inputcon1">
								...
								<?php
  								$result = mysql_query("SELECT * FROM servicecategories ORDER BY categoryid");
								if (!$result)
								{
