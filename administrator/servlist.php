...
<body>
	<div id="container">
					...
					?>
						  ...
						  <center><h5><?php echo "$id"; ?>Servmill posts Log</h5></center>
                           <div id="bodycon">
        ...
        <tbody>
        	<?php 
				$prodid = $_GET['id'];
				$query = mysql_query("SELECT * FROM bidreport LEFT JOIN member ON member.memberid = bidreport.bidder LEFT JOIN services ON services.serviceid = bidreport.serviceid WHERE services.serviceid = '$prodid'") or die(mysql_error());
